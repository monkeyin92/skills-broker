...
- [ ] 在不破坏 thin-shell / shared-home / proof-reuse 边界的前提下，把 OpenCode readiness contract 推进成真正的第三个宿主壳
- [ ] 在 `website QA` 与 `web markdown` 之外，继续增加更多被证据证明过的 default-entry families
- [ ] 增加更多 broker-owned workflow，而不只保留 `idea-to-ship` 这一条主链路
- [ ] 把 narrative docs parity、verification blind-spot reporting 与 coverage budget 提升到 CI 级质量门禁
...
---
*Last updated: 2026-04-23 after v1.0 milestone close*
