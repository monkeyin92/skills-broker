...
`doctor` now exposes a capability growth packet: provenance, install_required, verification, repeat usage, cross-host reuse, degraded/failed counts, and next action. Phase 20 now needs to turn that packet into one canonical truth rail.
